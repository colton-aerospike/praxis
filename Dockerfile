...
ENTRYPOINT /opt/praxis/praxis -h aerocluster-0-0.aerocluster.aerospike -U admin -P admin123 -k 10000 -n test -s myset -chan 500 -sT 10ms -q -iB mapBin -iV 8675309
