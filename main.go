...
func main() {
	...
	flag.BoolVar(&batch, "batch", false, "Turn on batch for read/write")
	flag.BoolVar(&write, "write", false, "Write records")
	flag.IntVar(&recordCount, "rc", 5000, "Set number of records to read/write")
	...
	flag.BoolVar(&del, "d", false, "Delete previous records with specified key (default: false)")
	...
	//flag.IntVar(&times, "t", 1, "Number of times to run in a loop/interval")
